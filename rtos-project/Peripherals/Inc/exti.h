 ...
 *      Author: Fesih TAN
 *      @brief: Provides the interface for the External Interrupt (EXTI) peripheral
 */
...
/**
 * Sets the trigger edge of the specified EXTI source by modifiying the EXTI RTSR and/or FTSR registers
 * @param source one of the external interrupt/event lines
 * @param trigger rissing edge, falling edge, or both
 */
 ...
 * @param soruce one of the external interrupt/event lines
