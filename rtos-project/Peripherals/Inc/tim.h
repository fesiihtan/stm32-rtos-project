 ...
 *      Author: Fesih TAN
 *      @brief: Contains function prototypes for initializing various timers used in the application
 */
...
/**
 * Initializes TIM2 to trigger ADC1 conversions for the internal temp sensor at 1 Hz
 *
 * Configuration steps:
 * 1. Enable TIM2 clock
 ...
 * 4. Force an update event to reload prescaler immediatley
 * 5. Enable TIM2 counter
 */
void tim2_init(void);

/**
 * Initializes TIM6 to create microsecond delays for Sensirion sensor communication
 *
 * Configuration steps:
 * 1. Enable TIM5 clock
